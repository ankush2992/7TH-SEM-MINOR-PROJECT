...
# Loading environment variables from .env snippet
load_dotenv()
...
class AzureVisionService:
    ...
    def extract_text(self, image, translate_to='en'):
        ...
        try:
            # Convert image to format Azure can use
            ...
            try:
                ...
                return {
                    ...
                    'translated_text': 'issue: Vision is not in service '
                }
            ...
            #return early if not texr founded.
